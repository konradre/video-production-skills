...
else Omni Flash 1.1, kie first (§ The talking-head default); a hook sweep → Omni 1.1 at 360p — the one Omni job fal does
cheaper, $0.03/s against kie's flat step price, so quote both;
