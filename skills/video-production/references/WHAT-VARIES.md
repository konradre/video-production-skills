...
| the prompt's style prefix | a photoreal live-action commercial, 9:16, clean exposure, no grain, no on-screen text | this project's genre, aspect and look; a creator-style spot swaps it for the phone-native dialect (a handheld iPhone shot at arm's length, window light, room tone — never "cinematic", the device never a prop) | `video-prompt-dialects` § 2, PHONE-NATIVE.md |
